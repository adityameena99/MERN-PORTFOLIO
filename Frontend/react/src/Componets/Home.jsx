  ...
  return (
    ...
    >
      ...
      <div
        ...
        z-[9999] font-a1 text-center pointer-events-none mix-blend-difference"
        style={{ color: "white" }}
      >
        <div className="text-[200px] leading-[1] whitespace-nowrap font-semibold">
          HELLO I'M
        </div>
        <div className="text-[140px] whitespace-nowrap leading-[1]">
          Aditya Meena
        </div>
      </div>
